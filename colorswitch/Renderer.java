...
public abstract class Renderer {
	...
	/**
	 * Calcule la position sur l'écran d'une entité à partir de sa position Y dans
	 * le niveau.
	 *
	 * @param level
	 *            Niveau actuel
	 * @param levelY
	 *            Coordonnée Y dans le niveau
	 * @return La coordonnée Y dans le système de coordonnées de la fenêtre JavaFX
	 */
